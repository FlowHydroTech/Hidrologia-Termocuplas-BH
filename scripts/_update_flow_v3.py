...
# -*- coding: utf-8 -*-
"""
Actualiza celdas 49 y 51 al estilo Flow v3 (docs técnicos):
  - Sans-serif (Calibri/Arial), sin grilla, ejes negros
  - Boxplot: borde completo, etiquetas limpias
  - Series: minimal, markers + líneas 1-1.5pt
"""
import json
...
IDX_CODE_SERIES = 48   # celda 49 (0-based=48)
IDX_CODE_BOXPLOT = 50  # celda 51 (0-based=50)

# ═══════════════════════════════════════════════════════════════════════════
# CELDA 49: SERIES TEMPORALES — TENDENCIA CENTRAL (FLOW V3)
# ═══════════════════════════════════════════════════════════════════════════
SRC_SERIES = r'''# =============================================================================
...
# ═══════════════════════════════════════════════════════════════════════════
# CELDA 51: BOXPLOT VERTICAL + MAPA SIG (FLOW V3)
# ═══════════════════════════════════════════════════════════════════════════
SRC_BOXPLOT = r'''# =============================================================================
...
# ── Leyenda ──────────────────────────────────────────────────────────────
legend_items = [
    mpatches.Patch(facecolor='#aaa', alpha=0.6, edgecolor='k', linewidth=0.8,
...
print(f'✅ Boxplot vertical (MAD, Flow v3) → {img_dir}')
plt.show()
...
# ══════════════════════════════════════════════════════════════════════════
# MAPA SIG — popups MAD-filtrados (sin cambios de estilo web)
# ══════════════════════════════════════════════════════════════════════════
...
def main():
    ...
    cells = nb['cells']
    print(f"Notebook: {len(cells)} celdas")
    ...
    print(f"  [49] Series temporales → Flow v3")

    # Celda 51 (boxplot + mapa)
    ...
    print(f"  [51] Boxplot + Mapa SIG → Flow v3")

    with open(NB_PATH, 'w', encoding='utf-8') as f:
        json.dump(nb, f, ensure_ascii=False, indent=1)

    print(f"\n✅ Actualizado con estilo Flow v3")
    print("   Cambios:")
    print("   → Sans-serif (Calibri/Arial)")
    print("   → Sin grilla")
    print("   → Ejes negros, bordes completos en boxplot")
    print("   → Unidades en [corchetes]")
